...
function generateUnRandomTime(schedule, renderStart, renderEnd) {
    ...
    schedule.start = startDate.toDate();
    endDate = moment(startDate);
    schedule.end = endDate.add(3, 'hour').toDate();
}
...
function generateUnRandomSchedule(calendar, renderStart, renderEnd) {
    var schedule = new ScheduleInfo();

    schedule.id = "SC01";
    schedule.calendarId = calendar.id;

    schedule.title = "John Doe";
    schedule.body = "Heart Patient";
    schedule.isReadOnly = false;
    generateUnRandomTime(schedule, renderStart, renderEnd);
...
function generateSchedule(viewName, renderStart, renderEnd) {
    ScheduleList = [];
    generateUnRandomSchedule(CalendarList[0], renderStart, renderEnd);
}
    ...
    //         console.log("yesf ");
    //         firs = 1;
    //         generateUnRandomSchedule(calendar, renderStart, renderEnd);
    //     }
    //     for (; i < length; i += 1) {
