export function square() {
    return <div class="{{CSS_PREFIX}}popup c5 {{CSS_PREFIX}}popup-detail">
  <div class="{{CSS_PREFIX}}popup-container">
    ...
    <div class="{{CSS_PREFIX}}section-detail">
        ...
        {{#if schedule.dnotes}}<div class="{{CSS_PREFIX}}popup-detail-item"><span class="{{CSS_PREFIX}}icon {{CSS_PREFIX}}ic-dnotes-b"></span><span class="{{CSS_PREFIX}}content">{{{popupDetailDnotes-tmpl schedule}}}</span></div>{{/if}}
